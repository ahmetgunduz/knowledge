...
Implementations: <<naive_BST>>, <<avl_tree>>, <<red_black_tree>>
...
- <<closest_pair_of_pionts_divide_and_conquer>>
...
A simpler variant of <<closest_pair_of_pionts_divide_and_conquer>>
