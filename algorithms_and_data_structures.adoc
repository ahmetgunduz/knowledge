...
Take a balanced binary search tree which stores it's values in it's leaves. Regarding storing data in leaves only, see <<naive_BST>>.  This is especially convenient for higher dimensions, see <<range_tree>>.
