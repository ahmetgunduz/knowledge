...
Contracting each strongly connected component of a directed graph G to a single vertex is called the _condensation_ of G. The condensation of G is a DAG and also called _kernel DAG_.
...
Finds the strongly connected components of a directed graph G in O(n) time.
...
--------------------------------------------------
  ...
  1 2 4 5 7 6 3    starting at 1
  1 2 3 4 5 6 7    starting at 1
  1 2 3 4 5 6 7    starting at 7, 4, 1
  2 3 1 6 4 5 7    starting at 7, 6, 2
--------------------------------------------------
...
Finds the strongly connected components of a directed graph in O(n) time.
...
- Princeton, Course Algorithms and Data Structures,
