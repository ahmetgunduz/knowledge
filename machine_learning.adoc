...
A common estimator θ̂ of the parameter θ is the MLE.  It turns out that here it is equivalen to the least squares estimator, which is based on directly minimizing the empirical risk of the training data, with MSE as loss function.
