...
_likelihood function_ ℒ~𝓓~(θ) = p(𝓓|θ) =~iid~ ∏p(d~i~|θ): Probability of seeing the data 𝓓 given the model parameters θ.
...
- Pro ML: ML only need differential calculus and can use gradient descent techniques.
